...
\begin{document}
  ...
  Measuring the similarity of two or more concepts is a task that frequently occurs in many real-world cases, where ontologies are employed, ranging from exploration of knowledge bases for information discovery --- as done in~\cite{GF13} --- to more technical activies, such as ontology alignment.
