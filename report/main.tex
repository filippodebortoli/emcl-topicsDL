...
% Deﬁnition 9 (unfoldable TBox). A TBox T is called a unfoldable TBox iﬀ it is acyclic, consists of concept deﬁnitions and primitive concept deﬁnitions only and every concept name occurs at most once on a left-hand side of a concept axiom.
